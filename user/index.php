							...
							<div class="container-fluid">
								<div class="row">
									<div class="navbar-header col-lg-5">
                                        <a class="navbar-brand" id="color" href="index.php">User Panel - WCSMS</a>
									</div>
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
								<ul id="menu" >
									<li><a href="../user"><i class="fa fa-fw fa-tachometer"></i><span>Dashboard</span></a></li>
                                    <li><a href="schedule/"><i class="fa fa-fw fa-calendar-plus-o"></i><span> Create New Schedule</span></a></li>
                                    <li><a href="schedule/search_schedule.php"><i class="fa fa-fw fa-search"></i><span> Search Schedules</span></a></li>
                                    ...
                                    <li><a href="class/"><i class="fa fa-fw fa-user-plus"></i><span> Manage Class</span></a></li>   
								</ul>	
							</div>
				</div> <!-- end side-bar -->
				<div class="clearfix"></div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Dashboard <small><?php echo $_SESSION['current_dept']?></small>
                </h1>
                ...
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"></div>
                                <div><b>Search Schedules</b></div>
                            </div>
                        </div>
                    </div>
                    <a href="schedule/search_schedule.php">
                        <div class="panel-footer">
                            <span class="pull-left">View Details</span>
                            <span class="pull-right"><i class="fa fa-arrow-circle-right fa-2x"></i></span>
                            <div class="clearfix"></div>
