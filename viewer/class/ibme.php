...
<?php include('../include/header.php'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="margin55">
                    <small>IBME Class Schedules</small>
                </h1>
                <hr>
            </div>
            <!-- <div class="century">
  ...
  <?php include 'ibme_class_get.php'; ?>
  <?php
  ...
  <div class="body">
       <h2 class="page-header aheader">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <a href="../../report/viewer/class_schedule.php?class=<?php echo $class_id; ?>" class="btn btn-danger pull-right"> <i class="fa fa-fw fa-print"></i> Print</a>
                </div>
            </div>
        </h2>
        <!--/.row -->  
