                            ...
                            <div class="container-fluid">
                                <div class="row">
                                  <div class="navbar-header col-lg-5">
                                      <a class="navbar-brand" id="color" href="../">Admin Panel - WCSMS</a>
                                  </div>
                                   <div class="navbar-header col-lg-7">
                                    <div class="navbar-form dropdown pull-right">
                                       ...
                                       <div class="navbar-form pull-right">
                                          <a class="btn btn-success" href="../schedule/instructor.php" data-toggle = "tooltip" data-placement = "bottom" title = "Faculty Schedule"> 
                                           <i class="fa fa-tasks"></i></a>
                                       </div>
                                       <div class="navbar-form pull-right">
                                          <a class="btn btn-warning" href="../schedule/room.php" data-toggle = "tooltip" data-placement = "bottom" title = "Room Schedule"> 
                                           <i class="fa fa-table"></i></a>
                                       </div>
                                       <div class="navbar-form pull-right">
                                         <a class="btn btn-primary" href="../schedule/class.php" data-toggle = "tooltip" data-placement = "bottom" title = "Class Schedule"> 
